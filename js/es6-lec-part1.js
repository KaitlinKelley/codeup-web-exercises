...
We are located in ${program.location}. The program lasts ${program.length} and you will learn ${program.technology}.`
...
//Remove function keyword, use arrow
let addOneB = (arg1) => {
    return arg1 + 1
};

//Remove curly braces and return keyword, only if there's only one return statement
